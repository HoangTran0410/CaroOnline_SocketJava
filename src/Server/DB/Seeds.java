...
public class Seeds {
    ...
    public void generate() {
        ...
        for (Friend f : fbus.getList()) {
            fbus.delete(f.getID());
        }
        Friend f1 = new Friend("uwu@yahoo.com", "meomeo@gmail.com", LocalDate.now().minusMonths(1));
        Friend f2 = new Friend("hasagi@yahoo.com", "asayo@skrr.com", LocalDate.now().minusMonths(2));
        Friend f3 = new Friend("ecec@ecec.com", "kimochi@jav.con", LocalDate.now().minusDays(10));
        Friend f4 = new Friend("poop@shit.com", "haha@yaha.com", LocalDate.now().minusDays(10));
        fbus.add(f1);
        fbus.add(f2);
        fbus.add(f3);
        fbus.add(f4);
